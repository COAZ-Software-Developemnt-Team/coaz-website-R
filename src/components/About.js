    ...
    return (
        <div className="relative flex flex-col w-full h-auto">
            ...
            <div className="relative flex flex-col w-full h-[60vh] shrink-0 overflow-x-hidden overflow-y-auto">
                ...
                />
                <div
                    className="absolute flex left-0 top-0 w-full h-full shrink-0 bg-linear-to-b from-[rgba(0,0,0,.8)] via-transparent to-[rgba(0,0,0,.8)]"/>
                <div
                    className="absolute flex flex-col space-y-4 items-center justify-center top-[166px] bottom-0 w-full">
            ...
            <div className="relative flex flex-col w-full h-auto px-[10%] shrink-0 bg-white">
                ...
                <div className="flex flex-col w-full h-auto space-y-8 pb-16">
                    <div className="flex flex-col space-y-4 w-full h-auto">
                        ...
                        <p className="text-[rgb(85,85,85)] text-lg font-jostSemi">
                            Our vision is to lead in enhancing the role and effectiveness of clinical officers in
                            delivering quality healthcare services across Zambia
                        </p>
