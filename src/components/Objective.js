...
const Objective = () => {
  return (
    <div className="flex flex-col w-full min-h-screen px-[10%] py-12 bg-white">
      ...
      {/* Intro text */}
      <p className="text-[rgb(85,85,85)] text-lg font-jostSemi mt-6 w-full">
        The Association will be governed in accordance with the following
        instruments, in order of precedence:
      </p>
      ...
      <div className="flex flex-col space-y-4 mt-6 w-full">
        ...
        <div className="flex flex-row space-x-4">
          ...
          />
          <p className="text-lg tracking-wider font-jostBook text-[rgb(85,85,85)]">
            Resolutions of the General Meeting, where consistent with the
            Constitution;
          </p>
        </div>
        ...
        <div className="flex flex-row space-x-4">
          ...
          />
          <p className="text-lg tracking-wider font-jostBook text-[rgb(85,85,85)]">
            By-laws and Regulations, enacted under this Constitution;
          </p>
        </div>
        ...
        <div className="flex flex-row space-x-4">
          ...
          />
          <p className="text-lg tracking-wider font-jostBook text-[rgb(85,85,85)]">
            The laws and statutes which apply or extend to the Association, as prescribed 
          </p>
        </div>

        <p className="text-[rgb(85,85,85)] text-lg font-jostSemi mt-6 w-full">
        No by-law, policy, rule, resolution, or directive of any organ or officer of the Association shall be 
valid to the extent that it is inconsistent with this Constitution. 
      </p>
      </div>
